...
Never use base r’s `table`\! The result is not helpful and to get to the
table function you have to do extra steps.
...
<img src="groupby_files/figure-gfm/unnamed-chunk-9-1.png" width="90%" />
...
<img src="groupby_files/figure-gfm/unnamed-chunk-12-1.png" width="90%" />

What about window functions?

Rank the coldest days and filter by the coldest day and then switch the
order:
